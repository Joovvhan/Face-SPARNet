...
def past_faces_back(img, hq_faces, tform_params, upscale=4):
    h, w = img.shape[:2]
...
def save_imgs(img_list, save_dir, i):
...
if __name__ == '__main__':
    ...
    img_paths = sorted(glob(opt.test_img_path + '/*.png')) 
    ...
    for i, img_path in enumerate(img_paths):
        ...
        save_imgs(aligned_faces, save_lq_dir, i)
        ...
        save_imgs(hq_faces, save_hq_dir, i)
        ...
        final_save_path = os.path.join(opt.results_dir, f'{i:02d}.jpg') 
